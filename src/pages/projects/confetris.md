...
<style>
    iframe {
        width: 100%;
        aspect-ratio: 100/58.9; // Doesn't match what's expected because of itch.io banner at the bottom
    }
</style>
...
Eventually, I decided to allow the player to make these design choices themselves, revealing them as configuration settings that could be modified, and Confetris (*conf*igurable T*etris*) started to take shape. I may return to this project to add even more customization options, but for now, I hope that it will bring some joy and surprise to those who give it a try.
...
<iframe title="Confetris" frameborder="0" src="https://itch.io/embed-upload/14599993?color=000000" allowfullscreen="" href="https://alexduchnowski.itch.io/confetris">Play CONFETRIS on itch.io</a></iframe>
